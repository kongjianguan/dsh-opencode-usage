window.__ModuleLoader__.load({
  ...
  factory: function (require) {
    ...
    function UsageChip(props) {
      ...
      var segs = WINDOWS.filter(function (w) { return show(w.key) }).map(function (w) {
        var u = data.windows[w.key]
        var pct = clampPct(u.usagePercent)
        return React.createElement('div', { className: 'ocu-seg', key: w.key },
          React.createElement('span', { className: 'ocu-seg-label' }, w.short),
          React.createElement('div', { className: 'ocu-seg-track' },
            React.createElement('div', { className: 'ocu-seg-fill', style: { width: pct + '%', background: pctColor(pct) } })
          ),
          React.createElement('span', { className: 'ocu-seg-pct', style: { color: pctColor(pct) } }, pct + '%')
        )
      })
      ...
      return React.createElement('div', {
        ...
        onBlur: function () { setExpanded(false) },
        ...
        React.createElement('div', {
          className: 'ocu-chip' + (busy ? ' ocu-busy' : ''),
        ...
        expanded ? React.createElement('div', { className: 'ocu-panel' },
